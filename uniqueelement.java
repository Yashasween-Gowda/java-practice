//program tp remove duplicate element from an array
...
This program sorts the array first, then iterates through it to identify and copy unique elements to a temporary array. Finally, it creates a result array of the appropriate size and returns it.
